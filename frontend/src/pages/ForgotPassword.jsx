...
function ForgotPassword() {
  ...
  return (
    <div className="bg-[var(--primary-blue)] flex items-center justify-center w-full h-screen">
      ...
      <form className="bg-[var(--light)] w-3/10 flex flex-col gap-4 p-12 rounded-2xl items-center relative">
        <button className="pi pi-angle-left flex items-center justify-center gap-4">
          Đăng nhập
        </button>
        ...
        <Button label="Xác nhận" className="bg-[var(--primary-yellow)]" />
      </form>
    </div>
  );
}
